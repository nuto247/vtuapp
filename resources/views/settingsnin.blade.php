                ...
                <div class="nk-content ">
                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                ...
                                <br><br>
                                 ...
                                 <form method="POST" action="{{ url('/nins') }}">
                                @csrf
                   ...
                   <td  width="300px" ><input type="text" placeholder="Enter the API Name" name="api" value="{{$settings->api}}"></td>
                      ...
                      <tr>
                            ...
                            <td  width="300px" ><input type="password" placeholder="Type the Network" name="username" value="{{$settings->username}}"></td>

</tr>
<tr>
                            <td width="300px"><input type="password" placeholder="Type the plan" name="password" value="{{$settings->password}}"></td>
