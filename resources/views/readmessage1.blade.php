        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Rechargnnnnnnnnnnnne Airtime</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <form method="GET" action="{{ url('/readmail') }}">
                                @csrf
                                ...
                                <br>
                                <textarea name="message" rows="10" cols="50" readonly>{{$readmails->message}}</textarea><br><br>
                                ...
                                <a href="../readmails"><button type="submit">Go back>></button></a>
                            </form>
                            <!-- ./col -->
                        </div>
                        <!-- /.row -->
