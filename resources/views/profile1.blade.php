                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Profile Page</h3>
...
<input type="text"  name="phone" value="{{$user->name}}" readonly><br><br>

<label >Your email:</label><br>
<input type="text"  name="phone" value="{{$user->email}}" readonly><br><br>
