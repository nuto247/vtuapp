                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Verify BVN</h3>
                                                    ...
                                                    <table class="table table-tranx">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="tb-tnx-item">
                                                                ...
                                                                <td class="tb-tnx-info">
                                                                    <img src="data:image/jpeg;base64,{{ data_get($bvn, 'photo') }}" >
                                                                </td>
                                                            </tr>
                                                            <tr class="tb-tnx-item">
                                                                <td class="tb-tnx-id">
                                                                ...
                                                                <td class="tb-tnx-info">
                                                                    {{ data_get($bvn, 'birthdate') }}
                                                                </td>
                                                            </tr>

                                                            @php
                                                                $residence = data_get($bvn, 'residence');
                                                            @endphp
