...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                        ...
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="/" class="logo-link">
                                    <img class="logo-light logo-img" src="./logo.png" srcset="./logo.png" alt="logo">
                                    <img class="logo-dark logo-img" src="./logo-dark.png" srcset="./logo.png" alt="logo">
                                </a>
                            </div><!-- .nk-header-brand -->
  ...
  <div class="row">
    ...
    <div class="card-body table-responsive p-0">
                                ...
                                <input type="hidden" name="password" id="password" value="uchetochukwu@gmail.com"><br><br><br>

                                <label for="phone">Phone Number:</label>
                                <br><br>
                                <input class="form-control" type="text" name="phone" id="phone" placeholder="Enter your phone number here">

                                <input class="form-control" type="hidden" name="network_id" id="network_id" placeholder="MTN" readonly>
<br><br>
                                ...
                                @foreach($dataprice as $data)
                                    <option value="500"> {{$data->plan}} </option>
