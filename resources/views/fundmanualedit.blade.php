                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                ...
                                <input type="hidden" name="password" id="password" value="revolutpay123">
                                ...
                                <br>
                              <font color="red"> Wallet balance is:  {{$user->balance}}</font>
                               <br>
                                <input type="text" name="amount" value="0"  placeholder="Type the amount you want to fund the wallet with"><br><br>
                                ...
                                <label >Status:</label> <font color="red">{{$user->status}}</font>
                                <br>
                                <select name="status" >
