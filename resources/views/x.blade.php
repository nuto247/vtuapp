                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="/" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="./logo.png" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="./logo.png"  alt="logo" width="200px">
                            </a>
                        </div>
                        <div class="card">
                                ...
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the Client Area by using your email and password.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-primary btn-block">Send Reset Password Link</button>
                                    </div>
                                </form>
