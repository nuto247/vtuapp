                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                ...
                                @csrf
                                 ...
                                 <input type="hidden" class="form-control no-resize" name="user_id" value="{{ $user->id }}">
                                   
                                                                <label class="form-label" for="default-textarea">Title</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control no-resize" name="title" placeholder="Type your title here">
                                                                </div>
                                 </div>
                                                            <div class="form-group">
                                                                <label class="form-label" for="default-textarea">Message</label>
                                                                <div class="form-control-wrap">
                                                                    <textarea class="form-control no-resize"  name="message">Type your message here</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
